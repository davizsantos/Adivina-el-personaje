...
public class Preguntas extends JPanel {
	...
	// static ara acceder desde "Ventana"
	static String preguntasArrayStr[] = new String[20];
	...
	void rellenarPreguntas() {
		...
		int cont = 0;
		preguntasArrayStr[cont] = "¿Es hombre?";
		cont++;
		preguntasArrayStr[cont] = "¿Tiene el pelo oscuro?";
		cont++;
		preguntasArrayStr[cont] = "¿Tiene el pelo rubio?";
		cont++;
		preguntasArrayStr[cont] = "¿Tiene el pelo blanco?";
		cont++;
		preguntasArrayStr[cont] = "¿Tiene el pelo pelirrojo?";
		cont++;
		preguntasArrayStr[cont] = "¿Tiene la nariz grande?";
		cont++;
		preguntasArrayStr[cont] = "¿Tiene coloretes?";
		cont++;
		preguntasArrayStr[cont] = "¿Tiene bigote?";
		cont++;
		preguntasArrayStr[cont] = "¿Tiene sombrero?";
		cont++;
		preguntasArrayStr[cont] = "¿Tiene barba?";
		cont++;
		preguntasArrayStr[cont] = "¿Tiene gafas?";
		cont++;
		preguntasArrayStr[cont] = "¿Tiene pendientes?";
		cont++;
		preguntasArrayStr[cont] = "¿Tiene el pelo largo?";
		cont++;
		preguntasArrayStr[cont] = "¿Tiene el pelo corto?";
		cont++;
		preguntasArrayStr[cont] = "¿Es calvo/semi-calvo?";
		cont++;
		preguntasArrayStr[cont] = "¿Las gafas son de color negro?";
		cont++;
		preguntasArrayStr[cont] = "¿Las gafas son de color azul?";
		cont++;
		preguntasArrayStr[cont] = "¿Las gafas son de color rojo?";
		cont++;
		preguntasArrayStr[cont] = "¿Tiene los ojos castaños?";
		cont++;
		...
		System.out.println("Añadiendo escuchador al panel de las preguntas...");
		listaPreguntas.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				// Se mira si es doble click
				if (e.getClickCount() == 2) {
					System.out.println("Añadiendo evento DOBLE CLICK...");
					int posicion = listaPreguntas.locationToIndex(e.getPoint());
					System.out.println("Se ha hecho doble click en la posicion " + posicion + " de la lista ("
							+ listaPreguntas.getSelectedValuesList() + ")");
		...
		System.out.println("Escuchador del planel de las preguntas añadido");

		System.out.println("JList creado");
	...
	protected void comprobarPregunta(List<Preguntas> listaPreguntas, Personaje personajeAdjudicado) {
		...
		if (preguntaSeleccionadaStr.equalsIgnoreCase("[¿Es hombre?]")) {
			if (personajeAdjudicado.isEsHombre()) {
				...
				// PopUp
				JOptionPane.showMessageDialog(getComponent(0), "Si, el personaje es hombre", "CORRECTO",
						getDefaultCloseOperation(), iconoOK);
			} else {
				System.out.println("No, el personaje no es hombre");
				JOptionPane.showMessageDialog(getComponent(0), "No, el personaje no es hombre", "INCORRECTO",
		...
		if (preguntaSeleccionadaStr.equalsIgnoreCase("[¿Tiene el pelo oscuro?]")) {
			if (personajeAdjudicado.getColorPelo().equalsIgnoreCase("oscuro")) {
				...
				// PopUp
				JOptionPane.showMessageDialog(getComponent(0), "Si, el personaje tiene el pelo oscuro", "CORRECTO",
						getDefaultCloseOperation(), iconoOK);
			} else {
				System.out.println("No, el personaje no tiene el pelo ");
				JOptionPane.showMessageDialog(getComponent(0), "No, el personaje no tiene el pelo oscuro", "INCORRECTO",
						getDefaultCloseOperation());
			}
		}
		if (preguntaSeleccionadaStr.equalsIgnoreCase("[¿Tiene el pelo rubio?]")) {
			if (personajeAdjudicado.getColorPelo().equalsIgnoreCase("rubio")) {
				...
				// PopUp
				JOptionPane.showMessageDialog(getComponent(0), "Si, el personaje tiene el pelo rubio", "CORRECTO",
						getDefaultCloseOperation(), iconoOK);
			} else {
				System.out.println("No, el personaje no tiene el pelo rubio");
				JOptionPane.showMessageDialog(getComponent(0), "No, el personaje no tiene el pelo rubio", "INCORRECTO",
						getDefaultCloseOperation());
			}
		}
		if (preguntaSeleccionadaStr.equalsIgnoreCase("[¿Tiene el pelo blanco?]")) {
			if (personajeAdjudicado.getColorPelo().equalsIgnoreCase("blanco")) {
				...
				// PopUp
				JOptionPane.showMessageDialog(getComponent(0), "Si, el personaje tiene el pelo blanco", "CORRECTO",
						getDefaultCloseOperation(), iconoOK);
			} else {
				System.out.println("No, el personaje no tiene el pelo blanco");
				JOptionPane.showMessageDialog(getComponent(0), "No, el personaje no tiene el pelo blanco", "INCORRECTO",
						getDefaultCloseOperation());
			}
		}
		if (preguntaSeleccionadaStr.equalsIgnoreCase("[¿Tiene el pelo pelirrojo?]")) {
			if (personajeAdjudicado.getColorPelo().equalsIgnoreCase("pelirrojo")) {
				...
				// PopUp
				JOptionPane.showMessageDialog(getComponent(0), "Si, el personaje tiene el pelo pelirrojo", "CORRECTO",
						getDefaultCloseOperation(), iconoOK);
			} else {
				System.out.println("No, el personaje no tiene el pelo pelirrojo");
				JOptionPane.showMessageDialog(getComponent(0), "No, el personaje no tiene el pelo pelirrojo",
						"INCORRECTO", getDefaultCloseOperation());
			}
		}
		if (preguntaSeleccionadaStr.equalsIgnoreCase("[¿Tiene la nariz grande?]")) {
			if (personajeAdjudicado.isNarizGrande()) {
				...
				// PopUp
				JOptionPane.showMessageDialog(getComponent(0), "Si, el personaje tiene la nariz grande", "CORRECTO",
						getDefaultCloseOperation(), iconoOK);
			} else {
				System.out.println("No, el personaje no tiene la nariz grande");
				JOptionPane.showMessageDialog(getComponent(0), "No, el personaje no tiene la nariz grande",
						"INCORRECTO", getDefaultCloseOperation());
			}
		}
		if (preguntaSeleccionadaStr.equalsIgnoreCase("[¿Tiene coloretes?]")) {
			if (personajeAdjudicado.isTieneColorete()) {
				...
				// PopUp
				JOptionPane.showMessageDialog(getComponent(0), "Si, el personaje tiene coloretes", "CORRECTO",
						getDefaultCloseOperation(), iconoOK);
			} else {
				System.out.println("No, el personaje no tiene coloretes");
				JOptionPane.showMessageDialog(getComponent(0), "No, el personaje no tiene coloretes", "INCORRECTO",
						getDefaultCloseOperation());
			}
		}
		if (preguntaSeleccionadaStr.equalsIgnoreCase("[¿Tiene bigote?]")) {
			if (personajeAdjudicado.isTieneBigote()) {
				...
				// PopUp
				JOptionPane.showMessageDialog(getComponent(0), "Si, el personaje tiene bigote", "CORRECTO",
						getDefaultCloseOperation(), iconoOK);
			} else {
				System.out.println("No, el personaje no tiene bigote");
				JOptionPane.showMessageDialog(getComponent(0), "No, el personaje no tiene bigote", "INCORRECTO",
						getDefaultCloseOperation());
			}
		}
		if (preguntaSeleccionadaStr.equalsIgnoreCase("[¿Tiene sombrero?]")) {
			if (personajeAdjudicado.isTieneSombrero()) {
				...
				// PopUp
				JOptionPane.showMessageDialog(getComponent(0), "Si, el personaje tiene sombrero", "CORRECTO",
						getDefaultCloseOperation(), iconoOK);
			} else {
				System.out.println("No, el personaje no tiene sombrero");
				JOptionPane.showMessageDialog(getComponent(0), "No, el personaje no tiene sombrero", "INCORRECTO",
						getDefaultCloseOperation());
			}
		}
		if (preguntaSeleccionadaStr.equalsIgnoreCase("[¿Tiene barba?]")) {
			if (personajeAdjudicado.isTieneBarba()) {
				...
				// PopUp
				JOptionPane.showMessageDialog(getComponent(0), "Si, el personaje tiene barba", "CORRECTO",
						getDefaultCloseOperation(), iconoOK);
			} else {
				System.out.println("No, el personaje no tiene barba");
				JOptionPane.showMessageDialog(getComponent(0), "No, el personaje no tiene barba", "INCORRECTO",
						getDefaultCloseOperation());
			}
		}
		if (preguntaSeleccionadaStr.equalsIgnoreCase("[¿Tiene gafas?]")) {
			if (personajeAdjudicado.isTieneGafas()) {
				...
				// PopUp
				JOptionPane.showMessageDialog(getComponent(0), "Si, el personaje tiene gafas", "CORRECTO",
						getDefaultCloseOperation(), iconoOK);
			} else {
				System.out.println("No, el personaje no tiene gafas");
				JOptionPane.showMessageDialog(getComponent(0), "No, el personaje no tiene gafas", "INCORRECTO",
						getDefaultCloseOperation());
			}
		}
		if (preguntaSeleccionadaStr.equalsIgnoreCase("[¿Tiene pendientes?]")) {
			if (personajeAdjudicado.isTienePendientes()) {
				...
				// PopUp
				JOptionPane.showMessageDialog(getComponent(0), "Si, el personaje tiene pendientes", "CORRECTO",
						getDefaultCloseOperation(), iconoOK);
			} else {
				System.out.println("No, el personaje no tiene pendientes");
				JOptionPane.showMessageDialog(getComponent(0), "No, el personaje no tiene pendientes", "INCORRECTO",
						getDefaultCloseOperation());
			}
		}
		if (preguntaSeleccionadaStr.equalsIgnoreCase("[¿Tiene el pelo largo?]")) {
			if (personajeAdjudicado.getTipoPelo().equalsIgnoreCase("largo")) {
				...
				// PopUp
				JOptionPane.showMessageDialog(getComponent(0), "Si, el personaje tiene el pelo largo", "CORRECTO",
						getDefaultCloseOperation(), iconoOK);
			} else {
				System.out.println("No, el personaje no tiene el pelo largo");
				JOptionPane.showMessageDialog(getComponent(0), "No, el personaje no tiene el pelo largo", "INCORRECTO",
						getDefaultCloseOperation());
			}
		}
		if (preguntaSeleccionadaStr.equalsIgnoreCase("[¿Tiene el pelo corto?]")) {
			if (personajeAdjudicado.getTipoPelo().equalsIgnoreCase("corto")) {
				...
				// PopUp
				JOptionPane.showMessageDialog(getComponent(0), "Si, el personaje tiene el pelo corto", "CORRECTO",
						getDefaultCloseOperation(), iconoOK);
			} else {
				System.out.println("No, el personaje no tiene el pelo corto");
				JOptionPane.showMessageDialog(getComponent(0), "No, el personaje no tiene el pelo corto", "INCORRECTO",
						getDefaultCloseOperation());
			}
		}
		if (preguntaSeleccionadaStr.equalsIgnoreCase("[¿Es calvo/semi-calvo?]")) {
			if (personajeAdjudicado.getTipoPelo().equalsIgnoreCase("calvo")) {
				...
				// PopUp
				JOptionPane.showMessageDialog(getComponent(0), "Si, el personaje es calvo/semi-calvo", "CORRECTO",
						getDefaultCloseOperation(), iconoOK);
			} else {
				System.out.println("No, el personaje no es calvo/semi-calvo");
				JOptionPane.showMessageDialog(getComponent(0), "No, el personaje no es calvo/semi-calvo", "INCORRECTO",
						getDefaultCloseOperation());
			}
		}
		if (preguntaSeleccionadaStr.equalsIgnoreCase("[¿Las gafas son de color negro?]")) {
			if (personajeAdjudicado.getColorGafas().equalsIgnoreCase("negro")) {
				...
				// PopUp
				JOptionPane.showMessageDialog(getComponent(0), "Si, las gafas del personaje son de color negro",
						"CORRECTO", getDefaultCloseOperation(), iconoOK);
			} else {
				System.out.println("No, las gafas del personaje no son de color negro");
				JOptionPane.showMessageDialog(getComponent(0), "No, las gafas del personaje no son de color negro",
						"INCORRECTO", getDefaultCloseOperation());
			}
		}
		if (preguntaSeleccionadaStr.equalsIgnoreCase("[¿Las gafas son de color azul?]")) {
			if (personajeAdjudicado.getColorGafas().equalsIgnoreCase("azul")) {
				...
				// PopUp
				JOptionPane.showMessageDialog(getComponent(0), "Si, las gafas del personaje son de color azul",
						"CORRECTO", getDefaultCloseOperation(), iconoOK);
			} else {
				System.out.println("No, las gafas del personaje no son de color azul");
				JOptionPane.showMessageDialog(getComponent(0), "No, las gafas del personaje no son de color azul",
						"INCORRECTO", getDefaultCloseOperation());
			}
		}
		if (preguntaSeleccionadaStr.equalsIgnoreCase("[¿Las gafas son de color rojo?]")) {
			if (personajeAdjudicado.getColorGafas().equalsIgnoreCase("rojo")) {
				...
				// PopUp
				JOptionPane.showMessageDialog(getComponent(0), "Si, las gafas del personaje son de color rojo",
						"CORRECTO", getDefaultCloseOperation(), iconoOK);
			} else {
				System.out.println("No, las gafas del personaje no son de color rojo");
				JOptionPane.showMessageDialog(getComponent(0), "No, las gafas del personaje no son de color rojo",
						"INCORRECTO", getDefaultCloseOperation());
			}
		}
		if (preguntaSeleccionadaStr.equalsIgnoreCase("[¿Tiene los ojos castaños?]")) {
			if (personajeAdjudicado.getColorOjos().equalsIgnoreCase("castaños")) {
				...
				// PopUp
				JOptionPane.showMessageDialog(getComponent(0), "Si, las los ojos del personaje son castaños",
						"CORRECTO", getDefaultCloseOperation(), iconoOK);
			} else {
				System.out.println("No, las los ojos del personaje no son castaños");
				JOptionPane.showMessageDialog(getComponent(0), "No, las los ojos del personaje no son castaños",
						"INCORRECTO", getDefaultCloseOperation());
			}
		}
